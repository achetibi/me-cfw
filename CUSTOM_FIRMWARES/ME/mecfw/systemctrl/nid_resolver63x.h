...
//	{ 0xCF4DE78C , 0x208F4820 },//sceKernelGetUIDcontrolBlock +
	...
	{ 0x82D3CEE3 , 0xC0CDE394 },// +
	{ 0xFC207849 , 0x6316DAC9 },// +
...
static Nid_list Nid_loadcore[] =
{
	...
	{ 0xEC20C661 , 0xF871EA38 },//LoadCoreForKernel_F871EA38 +
	{ 0xCDCAA8B2 , 0x7396DD7E },//LoadCoreForKernel_7396DD7E +
	...
	{ 0xFB8AE27D , 0x312CA47E },//sceKernelFindModuleByAddress +
	{ 0xA6D40F56 , 0x18CFDAA0 },//LoadCoreForKernel_18CFDAA0 +
	{ 0xCCE4A157 , 0xED53894F },//sceKernelFindModuleByUID +
	{ 0x929B5C69 , 0xE15347E9 },//sceKernelGetModuleListWithAlloc +
//	{ 0x2952F5AC , 0xC237D677 },//sceKernelDcacheWBinvAll -
//	{ 0xD8779AC6 , 0x77E3CB6B },//sceKernelIcacheClearAll -
	{ 0x4440853B , 0x67F8DA3F },//LoadCoreForKernel_67F8DA3F +
	{ 0xFA3101A4 , 0x12A85ED1 },//LoadCoreForKernel_12A85ED1 +
	{ 0x0C0D8B7F , 0xDA143BE9 },//LoadCoreForKernel_DA143BE9 +
...
//	{ 0xB4D6FECC , 0xB63183B5 },//sceKernelApplyElfRelSection -
//	{ 0x54AB2675 , 0x23C81B66 }//sceKernelApplyPspRelSection -
};


//#define Nid_kdebug_no 0x1a
...
static Nid_list Nid_Iofile[] =
{
	...
	{ 0x73B7671F , 0xAA61C177 },//sceIoGetFdDebugInfo +
	{ 0x9B86630B , 0x64ED84C9 },//sceIoGetUID +
	{ 0x30E8ABB3 , 0x13A4DEB0 },//sceIoValidateFd +
	{ 0x411106BA , 0x74482CE3 },//sceIoGetThreadCwd +
//	{ 0x5216CE3F , 0x5BC52506 },//sceIoTerminateFd
	{ 0x42F954D4 , 0xBF50BAE8 },//sceIoAddHook +
	{ 0xBD17474F , 0x804DFCE6 }// +
...
static Nid_list Nid_ModuleMgr[] =
{
	...
	{ 0x1B91F6EC , 0xCC77F137 },//CC77F137?
	...
	{ 0x0CE03872 , 0xD162C43D },//sceKernelLoadModuleMs5 +
...
static Nid_list Nid_Dve[] =
{
	...
	{ 0xB2E4E437 , 0x92830E89 },//sceDveEnd +
	{ 0xD8863512 , 0xFA89E42C },//sceDveUnk10 +
	{ 0xDEB2F80C , 0xAA085C2A },//sceDveUnk12 +
	{ 0xF0CF5A67 , 0x3FFA90A3 },//sceDveSetDisplayMode +
	{ 0x93828323 , 0x0DD3C1B4 },//sceDveUnk6 +
...
static Nid_list Nid_Ge[] =
{
	...
	{ 0x9DA4A75F , 0x86551EBA },// +
	{ 0x8F185DF7 , 0xBDA9D2F5 },//sceGeEdramInit +
	{ 0x114E1745 , 0x6338386D },// +
	...
	{ 0xAEC21518 , 0x39F15186 },// +
	{ 0x7B481502 , 0x4508BF79 },// +
...
{
	{ 0x1F4011E6 , 0x6CB49301 },//sceCtrlSetSamplingMode +
	{ 0x28E71A16 , 0x6CB49301 },//=
	...
	{ 0x7CA723DC , 0x5B15473C },//sceCtrlSetButtonIntercept +
	{ 0x5E77BC8A , 0x33AB5BDB },//sceCtrlGetButtonIntercept +
	...
	{ 0x3A622550 , 0x18654FC0 },//sceCtrlPeekBufferPositive +
	{ 0xC4AAD55F , 0x18654FC0 },//=
	{ 0xC152080A , 0x02DD57CF },//sceCtrlPeekBufferNegative +
	{ 0x1F803938 , 0x9F3038AC },//sceCtrlReadBufferPositive +
	{ 0x454455AC , 0x9F3038AC },//=
	{ 0x60B81F86 , 0xEB5F1D7A },//sceCtrlReadBufferNegative +
...
*/	{ 0x5C56C779 , 0x5D8CE0B2 },//sceCtrlRegisterButtonCallback +
...
static Nid_list Nid_Umd[] =
{
	...
	{ 0xF8352373 , 0xAA66D818 },//sceUmdRegisterMediaPresentCallBack +
	{ 0x5469DC37 , 0xAC4709C0 },//sceUmdUnRegisterMediaPresentCallBack +
...
//	{ 0x737486F2 , 0xEBD177D6 },//scePowerSetClockFrequency?
	{ 0xD6E50D7B , 0x8BA12BAF },

	
	{ 0x04B7766E , 0x8BA12BAF },//scePowerRegisterCallback +
	...
	{ 0xC23AC778 , 0x50073719 },// +

	{ 0x57A098B4 , 0xA2D82221 },//scePowerGetCurrentTachyonVoltage 280 +
	{ 0x55D2D789 , 0xD0312080 },//scePowerGetTachyonVoltage +
	{ 0xDD27F119 , 0xBB702691 },//scePowerSetTachyonVoltage +
	...
	{ 0x53C1255D , 0x77342CBF },// +
	{ 0x8762BCE6 , 0x82B25808 },// +
	{ 0xCAE2A4CA , 0x8AEB1037 },// +
	{ 0xD24E6BEB , 0x6BCB6389 },// +
	{ 0x35B7662E , 0xE856A6C6 },// +
	{ 0xF9B4DEA1 , 0x3BB93FFE },// +
	{ 0xF06B96D4 , 0x58F9A7C3 },// +
	{ 0xB1A52C83 , 0xB7C54B9A },//scePowerGetCpuClockFrequencyFloat +

	{ 0x478FE6F5 , 0x9F53A71F },//scePowerGetBusClockFrequency +
	{ 0xBD681969 , 0x9F53A71F },//=
	{ 0x1688935C , 0x9F53A71F },//=
	...
	{ 0x3234844A , 0x8C306FBC },// +
	{ 0x94F5A53F , 0x08EC482C },//scePowerGetBatteryRemainCapacity +
	{ 0xE8E4E204 , 0xBE3AEA7F },//scePowerGetForceSuspendCapacity +
	...
	{ 0xA4D02055 , 0x835ADE3F },// +
	{ 0x3951AF53 , 0x20EC212D },//scePowerWaitRequestCompletion +

	{ 0xEFD3C963 , 0x6C4F9920 },//scePowerTick +
	{ 0x9C40E184 , 0x6C4F9920 },//=
...
static Nid_list Nid_Sysreg[] =
{
	...
	{ 0x3199CF1C , 0xD74D9041 },// =370
	{ 0x158AD4FC , 0x64FA9D42 },//sceSysregMeBusClockDisable +
	{ 0x07881A0B , 0x64FA9D42 },// =370
...
static Nid_list Nid_Display[ ] =
{
	...
	{ 0xAE0E8972 , 0x8930B3A9 },//sceDisplaySetPseudoVsync + ? 0x10B1710B
...
//	{ 0x7ED29E40 , 0x071C387D },//sceRtcSetTick //need not to resolve
...
{
	{ 0x98279CF1 , 0xAEBFD786 },//module_start
	...
	{ 0xBE8C1263 , 0xC1881EB5 },// +
	{ 0x835ECE6F , 0x44242CEB },// +
...
//	{ 0x4794C05C , },//sceMeEnableFunctions -- not exported
	{ 0x3D5F109C , 0xCDE4B1BD },//sceMeCore_driver_3D5F109C
	{ 0xD1EA3DFD , 0xBB0481ED },//sceMeCore_driver_D1EA3DFD
	{ 0x47DB48C2 , 0x99E4DBFA },//sceMeBootStart
};