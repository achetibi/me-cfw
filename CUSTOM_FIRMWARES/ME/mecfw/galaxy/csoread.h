...
{
	u32 magic	;					/* +0x00 : 'C','I','S','O'  0x4F534943               */
	unsigned long header_size;		/* +0x04 : header size (==0x18)                      */
	unsigned long long total_bytes;	/* +0x08 : number of original data size              */
	unsigned long block_size;		/* +0x10 : number of compressed block size           */
