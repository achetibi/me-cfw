...
#if PSP_MODEL == 0
	.function_list = {
		.BootLfatOpen	= 0x88604A1C,
		.BootLfatRead	= 0x88604B90,
		.BootLfatClose	= 0x88604B34,
		.CheckPspConfig	= 0x8860AD64,
		.DcacheClearAddr= 0x88601490,
		.IcacheClearAddr= 0x88600D3C,
	},
	.patch_list = {
		.BootLfatOpenPatch	= 0x88603E2C,
		.BootLfatReadPatch	= 0x88603E94,
		.BootLfatClosePatch	= 0x88603EB4,
		.CheckPspConfigPatch= 0x88603508,
		.KdebugPatchAddr	= 0x8860CE30,
		.BtHeaderPatchAddr	= 0x8860AD98,
		.LfatMountPatchAddr	= 0x88603E24,
		.LfatSeekPatchAddr1	= 0x88603E74,
		.LfatSeekPatchAddr2	= 0x88603E84,
		.LoadCorePatchAddr	= 0x88603310,
		.HashCheckPatchAddr	= 0x886038C8,
	},

#elif (PSP_MODEL == 1)
	.function_list = {
		.BootLfatOpen	= 0x88604AE4,
		.BootLfatRead	= 0x88604C58,
		.BootLfatClose	= 0x88604BFC,
		.CheckPspConfig	= 0x8860AE2C,
		.DcacheClearAddr= 0x88601558,
		.IcacheClearAddr= 0x88600E04,
	},
	.patch_list = {
		.BootLfatOpenPatch	= 0x88603EF4,
		.BootLfatReadPatch	= 0x88603F5C,
		.BootLfatClosePatch	= 0x88603F7C,
		.CheckPspConfigPatch= 0x886035EC,
		.KdebugPatchAddr	= 0x8860CEF8,
		.BtHeaderPatchAddr	= 0x8860AE60,
		.LfatMountPatchAddr	= 0x88603EEC,
		.LfatSeekPatchAddr1	= 0x88603F3C,
		.LfatSeekPatchAddr2	= 0x88603F4C,
		.LoadCorePatchAddr	= 0x886033D8,
		.HashCheckPatchAddr	= 0x88603990,
	},
#endif

	.memlmd_list = {
		.ModuleOffsetAddr	= 0x00000BC4,
		.SigcheckPatchAddr	= 0x00006914,
		.SigcheckFuncAddr	= 0x0000835C,//memlmd_2E208358
		.DecryptPatchAddr	= 0x000068F0,
		.DecryptFuncAddr	= 0x00008374,//memlmd_CA560AA6
	},	
};
